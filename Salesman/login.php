...
<html lang="en">
  <head>
    ...
    <link href="assets/css/salesmanstyle.css"rel="stylesheet">
    ...
    <section class="Form my-4 mx-5">
        <div class="container">
            <div class="row no-gutters">
                <div class="col-lg-5">
                    <img src="assets/images/sales1.jpg" class="image-fluid" alt="">
                </div>
                <div class="col-lg-7 px-5 pt-5">
                    <h1 class="font-weight-bold py-3">Salesman Login</h1>
                    <h4>Sign in to your account</h4>
                    <form action="loginconnect.php" method="post">
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text"  name="em" placeholder="Enter Email" class="form-control my-3 p-4" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
